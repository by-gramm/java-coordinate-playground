...
public class ResultView {
    ...
    public static void showCoordinates(List<Point> points) {
    ...
    private static List<String> createLines(List<Point> points) {
    ...
    private static void addPoint(List<String> coordinates, Point point) {
    ...
    private static String getLine(int y) {
        if (y % 2 == 0) {
    ...
    private static void showEndLines() {
